"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6472],{46472:(t,e,i)=>{i.r(e),i.d(e,{W3mDepositFromExchangeSelectAssetView:()=>z,W3mDepositFromExchangeView:()=>P});var n=i(88088),a=i(53227),o=i(40859),s=i(1024),r=i(83366),u=i(44458),c=i(48789),l=i(44963),d=i(60319),h=i(59306);i(82016),i(88364),i(12936);var p=i(94895),m=i(69428),g=i(34175);let y=(0,g.AH)`
  button {
    border: none;
...
`;var C=function(t,e,i,n){var a,o=arguments.length,s=o<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(a=t[r])&&(s=(o<3?a(s):o>3?a(e,i,s):a(e,i))||s);return o>3&&s&&Object.defineProperty(e,i,s),s};let z=class extends n.WF{constructor(){super(),this.unsubscribe=[],this.assets=r.g.state.assets,this.search="",this.onDebouncedSearch=A.w.debounce(t=>{this.search=t}),this.unsubscribe.push(r.g.subscribe(t=>{this.assets=t.assets}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return(0,n.qy)`
    ...
    `}onBuyClick(){u.I.push("OnRampProviders")}onInputChange(t){this.onDebouncedSearch(t.detail)}handleTokenClick(t){r.g.setPaymentAsset(t),u.I.goBack()}};z.styles=D,C([(0,a.wk)()],z.prototype,"assets",void 0),C([(0,a.wk)()],z.prototype,"search",void 0),z=C([(0,h.EM)("w3m-deposit-from-exchange-select-asset-view")],z)},48342:(t,e,i)=>{i(88364)},76182:(t,e,i)=>{var n=i(88088),a=i(53227),o=i(67786),s=i(34175),r=i(94895),u=i(21736),c=i(69428);let l=(0,s.AH)`
  :host {
    position: relative;
